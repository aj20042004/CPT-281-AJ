...
public:
    ...
    Iterator& operator ++ ();  // Moves the iterator forward for one position (prefix).    // returns the reference to the element after increment
    Iterator operator ++ (int);  // Moves the iterator forward for one position (postfix). // returns the copy of the element before increment
